...
\begin{frame}{Models tested}
  ...
  \begin{tabular}{lll}
    ...
    Provider & Model & API \\
    \midrule
    Anthropic   & Claude Opus 4.7, Sonnet 4.6, Haiku 4.5            & \texttt{claude} CLI \\
    OpenAI      & GPT-5.4, GPT-5.2, GPT-5.1, GPT-5, GPT-4.1         & SDK \\
    AWS Bedrock & DeepSeek-R1, DeepSeek V3.2                        & \texttt{bedrock-runtime} \\
    Google      & Gemini 2.5 Pro, 2.5 Flash-Lite,                   & REST \\
  ...
  \vspace{0.6em}
  \footnotesize
  \red{14 models, 4 providers}. Same planner prompt across all of them. No few-shot examples. Same router (deterministic, MCP-backed). Same 20-IP corpus. Same 9 cpu\_ip problems. Gemini 2.5 Flash and Gemini 3 Pro/3.1 Pro returned mostly 503s and are excluded.
\end{frame}
